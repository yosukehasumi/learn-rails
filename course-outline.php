<?php
  ...
  $subtitle = "What are we doing here anyway? Let's get a lay of the land";
?>
...
<ul>
  ...
  <li>Intro to Command line</li>
  <li>IRB (Interactive Ruby)</li>
  <li>Assignment: Git workflow (fork, pull, commit, push)</li>
</ul>
...
<ul>
  ...
  <li>Reading logs</li>
  <li>Assignment: Submit a proposal for your final project</li>  
</ul>
...
<ul>
  ...
  <li>View Partials</li>
  <li>Midterm: Take home, start your final project must have that has at least one model, one controller, one view, one migration, model validations, tests</li>  
</ul>
...
<ul>
  ...
  <li>SCSS, Sass, CSS</li>
  <li>AJAX</li>
  <li>Chrome console</li>
  <li>Assignment: Make revisions to final project as per my suggestions</li>
</ul>
...
<ul>
  ...
  <li>Heroku</li>
  <li>ENV variables</li>
  <li>Assignment: Deploy your final project to heroku</li>
</ul>
...
<ul>
  ...
  <li>JSON and API's</li>
  <li>Assignment: Connect a project to an API</li>  
</ul>
